...
function uri_today_settings_init() {
	...
	add_settings_field(
		...
		__( 'Post Status', 'uri_today' ), // title
...
function uri_today_domain_field( $args ) {
	...
	?>
		...
		<p class="url-description">
			<?php
				esc_html_e( 'Enter the domain of the API Endpoint, omit trailing slash.', 'uri_today' );
				echo '<br />';
...
// 	value="<?php print ($setting!==FALSE) ? esc_attr($setting) : ''; 
	...
	?>
		...
		<p class="category-description">
			<?php
				esc_html_e( 'Select the category for imported news posts.', 'uri_today' );
			?>
		</p>
	<?php
}
...
function uri_today_post_status_field( $args ) {
	...
	?>
		...
		<p class="post-status-description">
			<?php
				esc_html_e( 'Select the post status for newly imported posts.', 'uri_today' );
			?>
		</p>
	<?php
}
	...
	?>
		...
		<p class="oldest-date-description">
			<?php
				...
				echo '<br />';
				esc_html_e( 'e.g. 2016-01-01', 'uri_today' );
			?>
		</p>
	<?php
}
