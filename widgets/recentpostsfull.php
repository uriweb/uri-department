...
class RecentPosts2 extends WP_Widget {
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('spt'); ?>"><?php _e('Show Post Thumbnail', 'uri-department'); ?>
...
add_action ( 'widgets_init', 'RecentPosts2' );
function RecentPosts2() {
    return register_widget('RecentPosts2');
}
