...
// Homepage Data
$test_array = array("everywhere" => "On all pages","homeonly" => "Only on the homepage");
// Language Data
$options_langs = array("en" => "English","es" => "Spanish","fr" => "French","it" => "Italian","pt" => "Portuguese","de" => "German","ru" => "Russian");
// Multicheck Array
...
$options[] = array( "name" => "Basic Options",
		"type" => "heading");
...
$options[] = array( "name" => "Youtube Channel URL",
...
$options[] = array( "name" => "Homepage Setup",
		"type" => "heading");

$options[] = array( "name" => "Top Content",
...
$options[] = array( "name" => "Featured Links",
...
$options[] = array( "name" => "Department Alert",
...
$options[] = array( "name" => "Inline Custom CSS",
		"desc" => "Insert inline css here. Will be included throughout this department site.",
		"id" => "urid_cssinline",
		"std" => "",
		"type" => "textarea"); 

$options[] = array( "name" => "@Import Custom CSS",
		"desc" => "Insert an absolute link to an external css file which will be imported into the current design.",
		"id" => "urid_css",
		"std" => "",
		"type" => "text"); 

$options[] = array( "name" => "Inline Custom JS",
		"desc" => "Insert inline javascript here. Will be included throughout this department site.",
		"id" => "urid_jsinline",
		"std" => "",
		"type" => "textarea"); 

$options[] = array( "name" => "Left Sidebar Custom",
		"desc" => "Custom area for things under the left nav menu. Please do not use php here or ID's for DIVs, as Wordpress will strip out these tags.",
		"id" => "urid_html",
		"std" => "",
		"type" => "textarea");
