...
<?php if (of_get_option('urid_sitealert') == true) { ?>
...
<div class="post" id="post-<?php the_ID(); ?>">
  ...
  <div class="entry">
   ...
   <?php $contentoutput = of_get_option('urid_pagecontent'); apply_filters('the_content', $contentoutput); echo wpautop($contentoutput); ?>
...
<li>
<?php the_content(); ?><div class="slidecaption"><h3><?php the_title(); ?></h3><p><?php the_excerpt(); ?></p></div>
</li>
